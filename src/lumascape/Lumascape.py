...
class Lumascape:
    ...
    def make_circular(im):
        ...
        circular_im = Image.new(
            'RGBA', (diameter, diameter), (255, 255, 255, 255)
        )
        ...
        circular_im.paste(
            im.crop((x, y, x + diameter, y + diameter)), (0, 0), mask
        )
        return circular_im
    ...
    def draw_im(self):
        ...
        for i_group, [rect, [group, items]] in enumerate(
            zip(self.rects, self.group_to_items.items())
        ):
